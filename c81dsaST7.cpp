/*Given an array of 2n numbners, ech number from 1 to n in it occurs exactly twice.
We say that the segment y interesects x if exactly one occurence of the number y is between the occurences of the number x.
